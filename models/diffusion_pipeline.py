# this class was copied from Nathanael's repo and is responsible for generating an image given a trained diffusion model 
# (i.e. repeatedly invoking the unet wrapped by the diffusion model)
...
class DDPMPipeline1DCond(DiffusionPipeline):
    ...
    def __call__(
        ...
        for t in self.progress_bar(self.scheduler.timesteps):
            inputs = torch.cat((low_res, sig), dim=1)
